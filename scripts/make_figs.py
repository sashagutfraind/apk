...
str_prevalenceA = "python sweep_driver.py -m a -d 2014-08-21_STAMPEDE -p \"{'dossier_summaries_path':'2014-08-21_STAMPEDE/dossier_summaries-2014_08_21__14_39_48.pkl', 'plotting_round':[4]}\""
print(str_prevalenceA)
os.system(str_prevalenceA)

str_prevalenceB = "python sweep_driver.py -m a -d 2014-08-21_STAMPEDE -p \"{'dossier_summaries_path':'2014-08-21_STAMPEDE/dossier_summaries-2014_08_21__14_39_48.pkl', 'plotting_round':[3]}\""
...
#Fig cohort data
str_cohortA = "python sweep_driver.py -m e -d 2014-10-03--definitive"
print(str_cohortA)
