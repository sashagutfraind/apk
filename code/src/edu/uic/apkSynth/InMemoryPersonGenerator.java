 ...
 */
public class InMemoryPersonGenerator implements PersonGenerator{
	...
	private InMemoryPersonGenerator(List <DrugUser> unclassified_profiles_param, double maturity_threshold_param, int rng_seed) {
	 ...
	 */
	public static InMemoryPersonGenerator make_NEP_generator(HashMap<String, Object> population_params, double idu_maturity_threshold, int rng_seed) throws Exception {
		...
		InMemoryPersonGenerator pg = new InMemoryPersonGenerator(rl.getProfilesData(), idu_maturity_threshold, rng_seed);
