...
log using trials_VE75_Jun22.txt, text replace

/*** Vaccine simulation trials: VE 75 ***/
...
import delimited "vaccine_experiment_June_20_2022_results\events_history_`x'.csv", clear
drop v1
renvars, lower
rename v# t#, renumber
gen id = 1000 + _n
...
save VEsims500_VE75_Jun22.dta, replace
